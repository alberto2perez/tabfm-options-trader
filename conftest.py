...
_has_robin_stocks = importlib.util.find_spec("robin_stocks") is not None
collect_ignore = []
if not _has_torch:
...
# Live adapter tests require robin_stocks for Robinhood integration.
if not _has_robin_stocks:
  collect_ignore.append("tabfm/trading/tests/test_live_adapter.py")
